...
export default function GoodreadrPrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Goodreadr Privacy Policy | KlaudSol - Premium Shopify E-commerce Apps</title>
            ...
            <div className="row">
              <div className="col-md-7 col-sm-6">
                <div className="about-content">
                  <h2>GoodreadR Book Reviews Privacy Policy</h2>
                  <p>
                    GoodreadR Book Reviews ("the App”) provides the ability to add a
                    Goodreads Book Reviews wiget ("the Service") to merchants who use
                    ...
                    install or use the App in connection with your Shopify-supported
                    store.
                  </p>
